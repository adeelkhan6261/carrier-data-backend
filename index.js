...
try {
    if (process.env.FIREBASE_SERVICE_ACCOUNT) {
        ...
        admin.initializeApp({ projectId: 'cold-messenger-d6d43' });
    }
} catch (e) {
...
app.get('/', (req, res) => {
    res.json({ 
        status: 'ok', 
        service: 'CarrierDataPro Vercel/Supabase Backend',
        firebaseStatus: firebaseInitError ? 'Failed: ' + firebaseInitError : 'Success'
    });
});
